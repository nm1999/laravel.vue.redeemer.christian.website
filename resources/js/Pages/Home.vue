...
const previousSlide = () => {
    activeSlide.value =
        (activeSlide.value - 1 + carouselSlides.length) % carouselSlides.length;
};
    ...
    <Layout>
        ...
        >
            <div class="relative h-[68vh] min-h-[460px] max-h-[760px]">
                ...
                <div
                    class="absolute inset-0 bg-gradient-to-r from-slate-950/80 via-slate-900/45 to-slate-900/20"
                />
                <div
                ...
                <div
                    class="relative z-10 flex h-full items-end p-6 sm:p-10 lg:p-14"
                >
                    <div class="max-w-3xl text-white">
                        <p
                            class="inline-flex rounded-full bg-white/20 px-4 py-2 text-xs font-semibold uppercase tracking-[0.25em] text-white backdrop-blur-sm"
                        >
                            {{ heroSlides[activeHeroSlide].kicker }}
                        </p>
                        <h1
                            class="mt-5 text-4xl font-bold tracking-tight sm:text-5xl lg:text-6xl"
                        >
                            {{ heroSlides[activeHeroSlide].title }}
                        </h1>
                        <p
                            class="mt-4 max-w-2xl text-base text-slate-100 sm:text-lg"
                        >
                        ...
                        >
                            <Link
                                href="/about"
                                class="inline-flex items-center justify-center rounded-full bg-red-600 px-7 py-3 text-sm font-semibold text-white transition hover:bg-red-700"
                            >
                                Learn More
                            </Link>
                            <Link
                                href="/contact"
                                class="inline-flex items-center justify-center rounded-full border border-white/70 bg-white/10 px-7 py-3 text-sm font-semibold text-white backdrop-blur-sm transition hover:bg-white/20"
                            >
                                Plan Your Visit
                            </Link>
                        </div>
        ...
        >
            ...
            >
                <p
                    class="text-sm font-semibold uppercase tracking-[0.2em] text-red-700"
                >
                    Our Vision
                </p>
                <p class="mt-4 leading-7 text-slate-700">
        ...
        <br />
        <section
            class="scroll-reveal reveal-from-bottom relative overflow-hidden rounded-[32px] border border-slate-200 bg-gradient-to-br from-sky-50 via-white to-red-50 p-8 shadow-2xl shadow-slate-300/40"
        >
            <div
                class="absolute inset-x-0 top-0 h-72 bg-[radial-gradient(circle_at_top,_rgba(59,130,246,0.18),_transparent_35%)]"
            />
            <div
                class="absolute left-0 top-1/3 h-72 w-72 rounded-full bg-red-200/40 blur-3xl"
            ></div>
            <div
                class="absolute right-0 bottom-0 h-72 w-72 rounded-full bg-blue-200/60 blur-3xl"
            ></div>

            <div
                class="relative grid gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:items-center"
            >
                <div class="space-y-8">
                    <div class="space-y-4">
                        <p
                            class="inline-flex items-center gap-2 rounded-full bg-red-100 px-4 py-2 text-sm font-semibold uppercase tracking-[0.25em] text-red-700"
                        >
                            Welcome home
                        </p>
                        <h1
                            class="text-4xl font-bold tracking-tight text-slate-900 sm:text-5l"
                        >
                            Redeemer Church: a brighter place for faith, family,
                            and fresh hope.
                        </h1>
                        <p class="max-w-3xl text-lg leading-8 text-slate-700">
                            Explore worship, groups, stories, and service
                            opportunities designed to help you grow spiritually
                            and feel connected in every season.
                        </p>
                    </div>
                    ...
                    >
                        ...
                        <Link
                            href="/contact"
                            class="inline-flex items-center justify-center rounded-full border border-blue-200 bg-white px-6 py-3 text-sm font-semibold text-blue-700 transition hover:bg-blue-50"
                    ...
                    <div class="grid gap-4 sm:grid-cols-2">
                        <div
                            class="rounded-[28px] bg-white/90 p-6 shadow-lg shadow-slate-200/60"
                        >
                            <p
                                class="text-sm uppercase tracking-[0.2em] text-blue-700"
                            >
                            ...
                            >
                                Sunday worship at 8AM
                            </p>
                            <p class="mt-2 text-slate-600">
                                A warm service with music, teaching, and kids
                                ministry for every age.
                            </p>
                        </div>
                        <div
                            class="rounded-[28px] bg-white/90 p-6 shadow-lg shadow-slate-200/60"
                        >
                            <p
                                class="text-sm uppercase tracking-[0.2em] text-red-700"
                            >
                                Plan a visit
                            </p>
                            <p
                            ...
                            <p class="mt-2 text-slate-600">
                                Clear directions, friendly parking, and a
                                welcoming team waiting for you.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div
                    class="relative overflow-hidden rounded-[32px] border border-slate-200 bg-white/95 p-8 shadow-2xl shadow-slate-300/30"
                >
                    <div
                        class="absolute inset-0 bg-[radial-gradient(circle_at_top_left,_rgba(59,130,246,0.14),_transparent_35%)]"
                    />
                    <div class="relative space-y-6">
                        <div
                            class="rounded-[32px] border border-blue-100 bg-slate-50/95 p-6 shadow-lg shadow-blue-100/40"
                        >
                            <p
                                class="text-sm uppercase tracking-[0.25em] text-blue-700"
                            >
                                Featured story
                            </p>
                            ...
                            <p class="mt-4 text-slate-600 leading-7">
                                Every week our church celebrates connection,
                                service, and steps toward new beginnings.
                            </p>
                        </div>

                        <div class="grid gap-4 sm:grid-cols-2">
                            <div
                                class="rounded-[28px] bg-blue-600/10 p-5 text-slate-900 transition duration-300 hover:-translate-y-1 hover:bg-blue-600/15"
                            >
                                <p
                                    class="text-sm uppercase tracking-[0.2em] text-blue-700"
                                >
                            ...
                            <div
                                class="rounded-[28px] bg-red-100/80 p-5 text-slate-900 transition duration-300 hover:-translate-y-1 hover:bg-red-100/95"
                            >
                                <p
                                    class="text-sm uppercase tracking-[0.2em] text-red-700"
                                >
            ...
            >
                <div class="relative min-h-[248px] px-6 py-8 sm:min-h-[220px]">
                    <Transition name="fade" mode="out-in">
                        ...
                        >
                            <p
                                :class="carouselSlides[activeSlide].labelClass"
        ...
        <section
            class="scroll-reveal reveal-from-bottom mt-12 grid gap-8 lg:grid-cols-2"
        >
            <article
                class="scroll-reveal reveal-from-left rounded-[32px] border border-slate-200 bg-white p-8 shadow-xl shadow-slate-200/60"
            ...
            >
                ...
                <h2 class="mt-4 text-3xl font-bold text-slate-900">
                    A welcoming church with modern warmth
                </h2>
                <p class="mt-4 text-slate-600 leading-8">
                    From easy parking and friendly greeters to inspiring
                    teaching and a safe children’s area, we’ve designed every
                    detail so your first visit feels natural and comfortable.
                </p>
                <ul class="mt-8 space-y-4 text-slate-700">
                    <li class="flex items-start gap-3">
                        <span
                            class="mt-1 inline-flex h-3 w-3 rounded-full bg-blue-600"
                        ></span
                        >Creative worship and music for every generation
                    </li>
                    <li class="flex items-start gap-3">
                        <span
                            class="mt-1 inline-flex h-3 w-3 rounded-full bg-blue-600"
                        ></span
                        >Clear teaching that connects scripture to life
                    </li>
                    <li class="flex items-start gap-3">
                        <span
                            class="mt-1 inline-flex h-3 w-3 rounded-full bg-blue-600"
                        ></span
                        >Small groups for growth, prayer, and new friendships
                    </li>
                </ul>
            </article>

            <article
                class="scroll-reveal reveal-from-right rounded-[32px] border border-slate-200 bg-blue-600/10 p-8 shadow-xl shadow-blue-100/70"
                style="--reveal-delay: 120ms"
            >
                <p class="text-sm uppercase tracking-[0.25em] text-blue-700">
                    Our heart
                </p>
                <h2 class="mt-4 text-3xl font-bold text-slate-900">
                    Faith that serves the city
                </h2>
                <p class="mt-4 text-slate-700 leading-8">
                    We believe faith is best lived in community. That means
                    prayer, outreach, and practical help where it matters most.
                </p>
                <div class="mt-8 grid gap-4 sm:grid-cols-2">
                    <div class="rounded-3xl bg-white p-5 shadow-sm">
                        ...
                        <p class="mt-3 text-slate-700">
                            Local food drives, mentoring, and support for
                            neighbors.
                        </p>
                    </div>
                    <div class="rounded-3xl bg-white p-5 shadow-sm">
                        ...
                        <p class="mt-3 text-slate-700">
                            Weekly small groups and discipleship for every
                            stage.
                        </p>
                    </div>
                </div>
        ...
        <section
            class="scroll-reveal reveal-from-bottom mt-12 rounded-[32px] border border-slate-200 bg-white p-8 shadow-2xl shadow-slate-200/40"
        >
            <div
                class="scroll-reveal reveal-from-bottom flex flex-wrap items-end justify-between gap-4"
            ...
            >
                <div>
                    ...
                    <h2 class="mt-3 text-3xl font-bold text-slate-900">
                        Life at Redeemer in pictures
                    </h2>
                </div>
                <p class="max-w-xl text-slate-600">
                    A few moments from worship, fellowship, and serving together
                    as a church family.
                </p>
            </div>
        ...
        <section
            class="scroll-reveal reveal-from-bottom mt-12 rounded-[32px] border border-slate-200 bg-white p-8 shadow-2xl shadow-slate-200/50"
            ...
            <div class="grid gap-10 lg:grid-cols-[1fr_0.8fr] lg:items-center">
                <div class="space-y-5">
                    ...
                    <h2 class="text-3xl font-bold text-slate-900">
                        A weekend of connection and fresh vision
                    </h2>
                    <p class="text-slate-600 leading-8">
                        Experience a welcoming service, an inspiring message,
                        and a community that wants to see you thrive.
                    </p>
                    <Link
                        href="/contact"
                        class="inline-flex items-center rounded-full bg-red-600 px-6 py-3 text-sm font-semibold text-white transition hover:bg-red-700"
                        >Save your spot</Link
                    >
                </div>

                <div
                    class="overflow-hidden rounded-[28px] bg-slate-100 p-6 shadow-inner shadow-slate-200/50"
                >
                    <div class="space-y-5">
                        <div class="rounded-[28px] bg-blue-600/10 p-6">
                            ...
                            >
                                Live worship and practical teaching
                            </p>
                        </div>
        ...
        >
            ...
            <Link
                href="/events"
                class="mt-5 inline-flex rounded-full bg-blue-600 px-5 py-2 text-sm font-semibold text-white"
                >View all events</Link
            >
        </section>

        <section
            v-if="activeLiveStream?.embed_url"
            class="scroll-reveal reveal-from-bottom mt-12 rounded-[32px] border border-slate-200 bg-white p-8 shadow-2xl shadow-slate-200/50"
            style="--reveal-delay: 120ms"
        >
            <h2 class="text-3xl font-bold text-slate-900">Watch Live</h2>
            <p class="mt-2 text-slate-600">
                Join our current live service stream.
            </p>
